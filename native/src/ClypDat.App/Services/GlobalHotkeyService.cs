...
// ClypDat's save-clip hotkey while actually playing. RegisterHotKey is the
...
public sealed class GlobalHotkeyService : IDisposable
{
    ...
    public void Start()
    {
        ...
        _thread = new Thread(RunMessageLoop) { IsBackground = true, Name = "ClypDat Global Hotkey" };
    ...
    {
        _hwnd = CreateWindowExW(0, "STATIC", "ClypDat Global Hotkey", 0, 0, 0, 0, 0, HwndMessage, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
