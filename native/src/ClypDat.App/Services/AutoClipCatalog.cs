...
public static class AutoClipCatalog
{
    public static readonly IReadOnlyList<AutoClipGameDefinition> Active = new[]
    {
        ...
        }, new[] { new AutoClipGroupDefinition("kills", "All Kills") }, DefaultPort: 3499, CoverAssetPath: "avares://ClypDat/Assets/cs2-cover.jpg"),
        ...
        }, new[] { new AutoClipGroupDefinition("kills", "All Kills") }, RequiresSetup: true, DefaultPort: 3500, CoverAssetPath: "avares://ClypDat/Assets/dota2-cover.jpg"),
        ...
        }, new[] { new AutoClipGroupDefinition("kills", "All Kills"), new AutoClipGroupDefinition("monsters", "All Epic Monsters"), new AutoClipGroupDefinition("objectives", "All Objectives") }, CoverAssetPath: "avares://ClypDat/Assets/league-cover.jpg")
    };
