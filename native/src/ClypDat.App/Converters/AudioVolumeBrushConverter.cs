...
public sealed class AudioVolumeBrushConverter : IValueConverter
{
    ...
    private static readonly IBrush Accent = AppThemeService.Brush("AccentBrush", "#5864E8");
    ...
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        value is double volume && volume > 125 ? Red : value is double level && level > 100 ? Amber : Accent;
