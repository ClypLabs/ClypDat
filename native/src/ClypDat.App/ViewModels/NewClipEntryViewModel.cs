...
// One row in the "New Clips!" popup shown when a game closes.
//
...
// DurationLabel, IsVod).
public sealed class NewClipEntryViewModel : ViewModelBase
{
    private bool _isSelected;
    private bool _isHovered;
    private bool _showCheckBox;

    public NewClipEntryViewModel(ClipCardViewModel clip) => Clip = clip;
