...
output="${CLYPDAT_LINUX_OUTPUT:-$repo_root/.local/linux-x64}"
avalonia="$(realpath "${CLYPDAT_AVALONIA_SOURCE:-$repo_root/../clypdat-avalonia}")"
...
cp -R native/gsr/patches native/gsr/protocols native/gsr/tests native/gsr/extension "$output/source/gsr/"
